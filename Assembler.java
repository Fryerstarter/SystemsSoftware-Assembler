	...
	public static void passTwo(String filename, String LOCCTR,Hashtable<String, Symbol> SYMTAB, Hashtable<String, Operation> OPTAB){
		try{
            ...
            if(line.getOPCODE().equals("START")){
            	...
            	String startLoc = line.getOPERAND();
            	String length = HexUtil.subHex(LOCCTR, startLoc);
            	String headerRecord = buildHeader(progName, startLoc, length);
            	objectFile.write(headerRecord);
            	objectFile.newLine();
            ...
            while((input = intermediateFile.readLine())!= null){
                ...
                while(!(line.getOPCODE().equals("END"))){
                	if(!isComment){
                		//line is not comment
                		if(OPTAB.get(line.getOPCODE())!= null){
                			...
                			String lengthOfObjectCodeInHalfBytes;
                			...
                			if(format != -1 && !isBase){
                				...
                				if(format == 1){
                					...
                					objectCode = HexUtil.buildFormat2(opCode, r1, r2);
                					lengthOfObjectCodeInHalfBytes = "4";
                				}else if(format == 3){
                					//need a way to identify index
                					if(# then immediate addressing){
                						n = 0;
                						i = 1;
                					}else{
                						n=1;
                					...
                					objectCode = HexUtil.buildFormat3(n, i, x, 0, opCode, memoryLoc, LOCCTR, BASE);
                					...
                					objectCode = HexUtil.buildFormat4(n, i, x, 1, opCode, memoryLoc);
                				}
